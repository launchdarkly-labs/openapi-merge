...
function merge(inputs) {
    ...
    const pathAndComponentResult = (0, paths_and_components_1.mergePathsAndComponents)(inputs);
    if ((0, data_1.isErrorResult)(pathAndComponentResult)) {
    ...
    const output = (0, extensions_1.mergeExtensions)({
        openapi: '3.0.3',
        info: (0, info_1.mergeInfos)(inputs),
        ...
        tags: (0, tags_1.mergeTags)(inputs),
        paths,
        components,
