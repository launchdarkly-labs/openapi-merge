...
function processComponents(results, components, areEqual, dispute, addModifiedReference) {
    for (const key in components) {
        ...
        if (components.hasOwnProperty(key)) {
            ...
            const modifiedKey = (0, dispute_1.applyDispute)(dispute, key, 'undisputed');
            if (modifiedKey !== key) {
            ...
            if (results[modifiedKey] === undefined || areEqual(results[modifiedKey], component)) {
                ...
                if (dispute !== undefined) {
                    const preferredSchemaKey = (0, dispute_1.applyDispute)(dispute, key, 'disputed');
...
function findUniqueOperationId(operationId, seenOperationIds, dispute) {
    ...
    if (dispute !== undefined) {
        const disputeOpId = (0, dispute_1.applyDispute)(dispute, operationId, 'disputed');
...
function mergePathsAndComponents(inputs) {
    ...
    for (let inputIndex = 0; inputIndex < inputs.length; inputIndex++) {
        ...
        const dispute = (0, dispute_1.getDispute)(input);
        const oas = dropPathItemsWithNoOperations((0, operation_selection_1.runOperationSelection)(lodash_1.default.cloneDeep(originalOas), operationSelection));
        ...
        if (oas.components !== undefined) {
            ...
            if (oas.components.schemas !== undefined) {
                ...
                processComponents(result.components.schemas, oas.components.schemas, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
            ...
            if (oas.components.responses !== undefined) {
                ...
                processComponents(result.components.responses, oas.components.responses, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
            ...
            if (oas.components.parameters !== undefined) {
                ...
                processComponents(result.components.parameters, oas.components.parameters, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
            ...
            if (oas.components.examples !== undefined) {
                ...
                processComponents(result.components.examples, oas.components.examples, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
            ...
            if (oas.components.requestBodies !== undefined) {
                ...
                processComponents(result.components.requestBodies, oas.components.requestBodies, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
            ...
            if (oas.components.headers !== undefined) {
                ...
                processComponents(result.components.headers, oas.components.headers, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
            ...
            if (oas.components.links !== undefined) {
                ...
                processComponents(result.components.links, oas.components.links, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
            ...
            if (oas.components.callbacks !== undefined) {
                ...
                processComponents(result.components.callbacks, oas.components.callbacks, (0, component_equivalence_1.deepEquality)(resultLookup, currentLookup), dispute, (from, to) => {
        ...
        (0, reference_walker_1.walkAllReferences)(oas, ref => {
